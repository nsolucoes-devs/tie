...
//Clientes
$route['d2fb359e7478da4e7ec01ef527bdeb53']                  = 'admin/adminclientes/oldClientes';
...
$route['ea0459301822166845dd9ff3084e3cdd/(:any)']           = "admin/adminclientes/editaCliente/$1";

$route['50d849c4ab008a40ab39cdaf352f35f5']                  = "admin/adminclientes/vercliente";
$route['50d849c4ab008a40ab39cdaf352f35f5/(:any)']           = "admin/adminclientes/vercliente/$1";
...
$route['admin/pedido/visualizaPedido/(:num)']                      = "admin/adminpedidos/visualizaPedido/$1";
...
$route['status']                                            = 'admin/campanha/statusLocacao';
$route['sms']                                               = 'admin/campanha/smsTexto';
$route['novoStatus']                                        = 'admin/campanha/gravaStatus';
$route['novoSmsTexto']                                      = 'admin/campanha/gravaSms';
$route['getSMS']                                            = 'admin/campanha/getSms';
$route['getSTS']                                            = 'admin/campanha/getSts';
$route['sendSMS']                                           = 'admin/campanha/sendSms';
...
$route['get-mais-locados']                          = 'restrito/gertMaisLocados';
...
$route['reservas/listagemajax']                     = "admin/reservas/listagemajax";

// $route['reservas-aluguel']                          = "admin/reservas/aluguel";
...
$route['consultaCliente']                           = "admin/reservas/buscaCliente";
$route['dependentesNovo']                           = "admin/reservas/gravaDependente";
$route['gravaCliente']                              = "admin/reservas/gravaCliente";
$route['buscaTraje']                                = "admin/reservas/buscaTrajes";
$route['showSelecteds']                             = "admin/reservas/showSelecteds";
$route['finalizaAluguel']                           = "admin/reservas/finaliza";
$route['finalRemoveAluguel']                        = "admin/reservas/removeFinal";  
$route['gravaLocacao']                              = "admin/reservas/gravaAluguel";  
$route['finalizaReserva']                           = "admin/reservas/encerraAluguel";  
$route['cupom/(:any)']                              = "impressoes/cupom/$1";  
$route['contrato/(:any)']                           = "impressoes/contrato/$1";  
$route['termo/(:any)']                              = "impressoes/termo/$1";
$route['orcamento/(:any)']                          = "impressoes/orcamento/$1";

$route['selecaoClienteDependente']                  = "admin/reservas/clienteDependente";

$route['OrcamentoReserva']                          = "admin/reservas/orcamento";
...
$route['dia']                                       = 'agenda/dia';

$route['status/listagem']                           = "admin/adminstatus/listagem";
$route['adminstatus/listagemajax']                  = "admin/adminstatus/listagemajax";
$route['adminstatus/verstatus/(:num)']              = "admin/adminstatus/verstatus?id=$1";
$route['adminstatus/editastatus/(:num)']            = "admin/adminstatus/editastatus?id=$1";

$route['adminreservas/editaaluguel']                = "admin/reservas/editaAluguel";
$route['adminreservas/visualiza']                   = "admin/reservas/visualizaAluguel";



$route['listaLocacao']                              = "admin/reservas/listagem";

$route['removeEstoque']                             = 'admin/Adminprodutos/removeVariante';
$route['updateEstoque']                             = 'admin/Adminprodutos/alteraVariante';
$route['insereNovoEstoque']                         = 'admin/Adminprodutos/novaVariante';


$route['updateStatus']                              = 'admin/campanha/gravaStatus';
$route['novoContratoTexto']                         = 'admin/adminajustes/gravaContrato';

$route['d2fb359e7478da4e7ec01ef527bdxxxx']          = 'admin/adminclientes/oldClientes';
$route['d2fb359e7478da4e7ec01ef527bdxxxx/(:num)']   = 'admin/adminclientes/oldClientes/$1';

$route['exibeCliente']                              = 'admin/adminclientes/clientesListagem';
$route['blockCliente/(:any)']                       = 'admin/adminclientes/activeCliente/$1';
$route['trashClienteTie']                           = 'admin/adminclientes/delCliente/';
$route['trashClienteTie/(:any)']                    = 'admin/adminclientes/delCliente/$1';
$route['editClienteTie/(:any)']                     = 'admin/adminclientes/editarcliente/$1';
$route['seeClienteTie/(:any)']                      = 'admin/adminclientes/vercliente/$1';
$route['editClienteTieOld/(:any)']                  = 'admin/adminclientes/newTieCliente/$1';
$route['seeClienteTieOld/(:any)']                   = 'admin/adminclientes/seeClienteOld/$1';
$route['clienteNewTie']                             = 'admin/adminclientes/cadastroCliente';
$route['blockClienteTie']                           = 'admin/adminclientes/bloqueioCliente';

$route['exibeClientesOld']                          = 'admin/adminclientes/exibeClientesOldTable';
