    ...
    <body>
                                                ...
                                                <div class="card-body" style="">
                                                    ...
                                                    <div class="col-md-12 text-right p-0"> 
                                                        ...
                                                        <div>
                                                            ...
                                                            <button class="btn btn-success" onclick="buscaTraje()" >Buscar <i class="fas fa-search"></i></button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
        ...
        <script>
            $( document ).ready(function() {
                $("#selectBusca").val("cpf").change();
                $('#buscaCpf').val('<?php echo $locacao['cpfCliente'];?>');
                $('#chaveLocacao').val('<?php echo $locacao['chaveLocacao'];?>');
                $("#dataAluguel").val("<?php echo $locacao['dataRetirada'];?>");
                $("#dataEntrega").val("<?php echo $locacao['dataDevolucao'];?>");
                $("#pagoTotal").val("<?php echo $locacao['pagamentos'];?>");
                ...
                $("#nomeAtendente").val("<?php echo $locacao['atendente'];?>").change();
