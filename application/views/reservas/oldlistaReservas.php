            ...
            <div class="c-card">
                ...
                <div class="c-card-body" style="display: block">
                    ...
                    <div style="display:none">
                        ...
                        <input type="date" class="form-control" placeholder="Período" id="periodo1" name="periodo1" value="<?php echo date('Y-m-d');?>">
                        <input type="date" class="form-control" placeholder="Período" id="periodo2" name="periodo2" value="<?php echo date('Y-m-d');?>">
                        ...
                        <select class="form-control" id="status" name="status">
                            ...
                            <option value="7">Locação Finalizada</option>
                            <option value="8">Locação Cancelada</option>
                        </select>
                    </div>
                    <div style="width: 100%">
...
<!-- FIM FUNÇÕES DE CHAMADAS CEP -->
<!-- FUNÇÕES DE DETALHES DE LOCAÇÃO -->
<script>
