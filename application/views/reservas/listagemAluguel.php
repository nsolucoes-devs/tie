    ...
    <div class="card h-100">
                    ...
                    <?php $lista=""; $total = 0; $aux = 1; foreach($lisTraje as $ltj){ ?>
                        <tr>
                            ...
                            <td class="col-md-2" style="height: 10rem;">
                                ...
                                <div class="col-md-12 h-50 text-center">
                                    <button type="button" class="btn btn-danger" onclick="remove(<?php echo $ltj['alg_id'];?>)"><i class="fa fa-trash" aria-hidden="true"></i></button>
                                </div>
                            </td>
                        </tr>
                        <tr>
        ...
        <div class="text-right">
            ...
            <button class="btn-lg btn btn-primary <?= !isset($colorbtn) ?: $colorbtn ?>" onclick="finalizaAluguel();">Próximo</button>
        </div>
    </div>
...
<script>
    ...
    function remove(id){
        ...
        dados.append('alg_id', id);

        console.log($('#chaveLocacao').val());
