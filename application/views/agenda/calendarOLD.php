            ...
            <div class="modal-body">
                <div class="bs-stepper">
                    <div class="bs-stepper-header" role="tablist">
                        ...
                        <div class="line"></div>
                        <div class="step" data-target="#aluguel-part">
                            <button type="button" class="step-trigger" role="tab" aria-controls="aluguel-part" id="aluguel-part-trigger">
                                <span class="bs-stepper-circle">3</span>
                                <span class="bs-stepper-label">Aluguel</span>
                            </button>
                        </div>
                    </div>
                    <div class="bs-stepper-content">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group-prepend">
                                                        <button onclick="resgataPecas()" class="btn btn-primary"><i class="fas fa-check-square-o"></i></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-prepend">
                                                <button onclick="buscaClienteNome()" class="input-group-text"><i class="fas fa-search"></i></button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-prepend">
                                                <button onclick="buscaClienteCpf()" class="input-group-text"><i class="fas fa-search"></i></button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-prepend">
                                                <button onclick="buscaClienteFone()" class="input-group-text"><i class="fas fa-search"></i></button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                            ...
                            <div id="aluguel-part" class="content" role="tabpanel" aria-labelledby="aluguel-part-trigger">
                                <div class="card-body">
                                    <div class="form-group">
                                        <label>Nome:</label>
                                        <div class="input-group">
...
<div class="modal fade" id="aluguelModal" tabindex="-1" role="dialog" aria-labelledby="eventModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="dataClicada"></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body" id="informacaoBuscada">
                <table id="listaAlugueisData" class="display" style="width:100%">
                    <thead>
                        <tr>
                            <th style="text-align-last:center;">#</th>
                            <th style="text-align-last:center;">Locador</th>
                            <th style="text-align-last:center;">Contato</th>
                            <th style="text-align-last:center;">Detalhes</th>
                        </tr>
                    </thead>
                    <tbody id="alugueis">
            ...
            /*new Draggable(containerEl, {
                ...
                var calendar = new Calendar(calendarEl, {
                  ...
                  dateClick: function(info) {
                    ...
                    dados = new FormData();
                    dados.append('data', info.dateStr);
                    $.ajax({
                        url: '<?php echo base_url('agendaDia'); ?>',
                        method: 'post',
                        data: dados,
                        processData: false,
                        contentType: false,
                        ...
                        success: function(data) {
                            $('#aluguelModal').modal('show');
                            var dia = info.dateStr;
                            dia = dia.split('-').reverse().join('/');
                            $('#dataClicada').html("Reservas para o dia: "+dia);
                            $('#alugueis').empty();
        ...
        <script>
            function buscaClienteNome(){
                alert('buscaClienteNome');
            }
            function buscaClienteCpf(){
                alert('buscaClienteCpf');
            }
            function buscaClienteFone(){
                alert('buscaClienteFone');
            }
            function resgataPecas(){
                alert("resgataPecas");
            }
        </script>
        ...
        <script>
            ...
            $(document).ready(function () {
                $('#listaAlugueisData').DataTable();
            });
            
            function detalhesLocacao(id){
                var height = 500;
                var width  = 600;
                ...
                window.open("<?php echo base_url('detalhesLocação');?>/"+id, 'detalhesLocação', features);
                window.close();
            }
