    ...
    <section class="wrapper">
        <nav aria-label="breadcrumb" style="margin-bottom: -25px; margin-top: 20px;">
            <ol class="breadcrumb" style="margin: 0; padding: 0; background-color: transparent">
                ...
                <li class="breadcrumb-item active"><a href="<?php echo base_url('954d03a8bbb7febfcd39f9e071407b4b') ?>">Locações</a></li>
            </ol>
        </nav>
        <div class="c-card">
            <div class="c-card-header">
                <div class="row px-3">
                    <div class="col-md-6 text-left">
                        <h2 style="color: #1b9045;"><b>Listagem de Locações</b></h2>
                    </div>
                    <div class="col-md-6">
                        <form action="<?php echo base_url('954d03a8bbb7febfcd39f9e071407b4b') ?>" method="post">
                            <div class="button-area">
                                ...
                                <div class="search-field">
                                    <select class="form-control form-control-custom" name="loja_id">
                                        <?php
            ...
            <div class="c-card-body" style="display: block">
                <div class="table-responsive" style="width: 100%">
                    <table class="table c-table" id="tabela">
                        <thead>
                            <tr>
                                <th class="text-center" style='width: 10%'>Nº Locação</th>
  ...
  <div class="modal-dialog" role="document" style="margin: 30px auto 0 auto;">
    <div class="modal-content">
        <div class="bg-dark" style="padding: 15px;">
            <h4 class="modal-title" style="color: white; display: inline;"><b>Excluir locação</b></h4>
            <button type="button" style="color: white" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
            </button>
      </div>
      <div class="modal-body">
          <p style="font-size: 16px;"><b>Deseja excluir o locação?</b></p>
      </div>
