...
<div class="modal fade" id="alteraModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog senha-dialog" role="document">
        <div class="modal-content">
            <div class="bg-dark" style="padding: 15px; border-radius: 4px 4px 0 0;">
                <h4 style="display:inline;" class="modal-title"><b>Alterar Senha</b></h4>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12 form-group">
                            ...
                            <div class="btn-senha">
                                <button type="button" class="see-pass" data-target="senha" style="border: none; background: linear-gradient(90deg, rgba(27, 144, 69) 0%, rgba(36, 189, 91) 70%);"><em class="fa fa-eye"></em></button>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 form-group">
                            ...
                            <div class="btn-senha">
                                <button type="button" class="see-pass" data-target="conf_senha" style="border: none; background: linear-gradient(90deg, rgba(27, 144, 69) 0%, rgba(36, 189, 91) 70%);"><em class="fa fa-eye"></em></button>
                            </div>
                        </div>
                    </div>
                </div>
