                    ...
                    <form class="col-md-6" action="<?php echo base_url('391a027a8fef2eba4487a00156901156') ?>" method="post">
                        <div>
                            <div class="button-area">
                                <a href="<?php echo base_url('ef0baa3c473197057bfddb0e9b0d6169') ?>"><button type="button" class="btn btn-secondary" style="margin-right: 15px" title="Adicionar Item"><em class="fa fa-plus"></em></button></a>
