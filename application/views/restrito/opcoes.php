            ...
            <div class="c-card-header">
                <div class="row px-3">
                    <div class="col-md-6 text-left">
                        <h2 class="text-secondary"><b>Listagem de Opções</b></h2>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="table-responsive" style="width: 100%">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="text-secondary" style="width: 30%">Categória</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="color: #1b9045; font-size: 22px!important" class="text-center">
			                    <a onclick="verMarca(<?php echo $o['opcao_id']; ?>, '<?php echo $o['opcao_nome']; ?>', '<?php echo $o['opcao_categoria']; ?>')" style="color: #1b9045;" data-toggle="modal" data-target="#marca_vermodal"><i class="fa fa-eye text-secondary" aria-hidden="true"></i></a>
			                    <a onclick="editarMarca(<?php echo $o['opcao_id']; ?>, '<?php echo $o['opcao_nome']; ?>', '<?php echo $o['opcao_categoria']; ?>')" style="color: #1b9045;" data-toggle="modal" data-target="#marca_editarmodal"><i style="padding-left: 12px;" class="fa fa-pencil text-secondary" aria-hidden="true"></i></a>
			                    <i onclick="excluirMarca(<?php echo $o['opcao_id']; ?>)" data-toggle="modal" data-target="#marca_excluirmodal" style="padding-left: 12px; color: #1b9045" class="fa fa-trash text-secondary" aria-hidden="true"></i>
    			            </td>
			            </tr>   
			            <?php } ?>
                    </tbody>
...
<div class="modal fade" id="marca_editarmodal" tabindex="-1" role="dialog" aria-labelledby="marca_editarmodal" aria-hidden="true">
  <div class="modal-dialog" role="document" style="margin: 30px auto 0 auto">
    <div class="modal-content">
      <div class="bg-dark" style="padding: 15px;">
        <h4 class="modal-title" style="color: white; display: inline;"><b>Editar Opção</b></h4>
        <button type="button" style="color: white" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
<div class="modal fade" id="marca_vermodal" tabindex="-1" role="dialog" aria-labelledby="marca_vermodal" aria-hidden="true">
  <div class="modal-dialog" role="document" style="margin: 30px auto 0 auto">
    <div class="modal-content">
      <div class="bg-dark" style="padding: 15px;">
        <h4 class="modal-title" style="color: white; display: inline;"><b>Opção</b></h4>
        <button type="button" style="color: white" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
