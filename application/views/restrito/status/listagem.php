    ...
    <section class="wrapper">
        <nav aria-label="breadcrumb" style="margin-bottom: -25px; margin-top: 20px;">
                <ol class="breadcrumb" style="margin: 0; padding: 0; background-color: transparent">
                    ...
                    <li class="breadcrumb-item active"><a href="<?php echo base_url('reservas/listagem') ?>">Status</a></li>
                </ol>
            </nav>
            <div class="c-card">
                <div class="c-card-header">
                     <div class="row">
                        <div class="col-md-6 text-left">
                            <h2 style="color: #1b9045;"><b>Listagem de Status</b></h2>
                        </div>
                        <form id="filter-form">
                            <div class="col-md-6">
                                <div class="button-area">
                                    <button type="button" class="btn btn-primary" style="margin-right: 15px" title="Adicionar Item" data-toggle="modal" data-target="#modalCreateStatus">Novo Status <i class="fa fa-plus"></i></button>
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" name="newstatus_name">
                        </div>
                        <div class="form-group col-md-3">
                            <label for="message-text" class="col-form-label">Posição</label>
                            <input type="number" min="1" class="form-control" name="newstatus_position">
                        </div>
                        <div class="form-group col-md-2">
                            <label for="message-text" class="col-form-label">Cor</label>
                            <input type="color" class="form-control" name="newstatus_color">
                        </div>
                        <div class="form-group col-md-3">
    ...
    $(document).ready(function($) {
        ...
        dataTable = $('#status-list').DataTable({
            ...
            "columns": [
                ...
                { data: "name_status"},
                { data: "active_status", class: "text-center"},
