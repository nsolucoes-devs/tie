        ...
        <div class="c-card">
            <div class="c-card-header">
                <div class="col-md-6 text-left">
                    <h2 class="text-secondary"><b>Visualizar Departamento</b></h2>
                </div>
                <div class="col-md-6">
                    <a href="<?php echo base_url('48b6bbfcf12b55d9b0e4c2ded7384bff') ?>"><i style="margin-top: 5%; padding: 10px;" class="btn btn-secondary fa fa-reply" aria-hidden="true"> VOLTAR</i></a>
                </div>
            </div>
                            ...
                            <div id="dados">
                                ...
                                <div class="row" style="margin-top: 2%">
                                    <div class="col-md-12 form-group">
                                        ...
                                        <select class="form-control w-100" id="situacao" name="situacao" disabled>
