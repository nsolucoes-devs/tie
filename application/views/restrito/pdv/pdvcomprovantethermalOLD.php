            ...
            <table id="myTable2" class="table table-hover table-bordered" style="font-size: 8px" >
    		    <thead>
    		        <tr style="border-style: dotted; ">
    		            ...
    		            <th><p style="font-size:5px; font-weight: bold; text-align: center">COR</p></th>
    		    ...
    		    <tbody>
    		        <?php $aux=0; foreach($listas as $row){
    		            echo"<tr style='border-style: dotted;'>
    		                ...
    		                <td style='text-align: center; vertical-align: middle;'><p style='font-size:5px; font-weight: bold; text-align: center'>" . $produtos[$aux]['cor'] . "</p></td>
		...
		<div class="row">
            <div class="col-xs-4">
                <?php if($compra['acrescimo_compra'] != 0){?>
                    <p style="font-size:8px; font-weight: bold; text-align: left">ACRÉSCIMO: <?php echo $compra['acrescimo_compra']?>%</p>
                <?php }?>
                <?php if($compra['desconto_compra'] != 0){?>
                    <p style="font-size:8px; font-weight: bold; text-align: left">DESCONTO: <?php echo $compra['desconto_compra']?>%</p>
                <?php }?>
