        ...
        <section class="wrapper">
            ...
            <div class="c-card">
                <div class="c-card-header">
                    <div class="row">
                        <div class="col-md-6 text-left">
                            <h2 class="text-secondary"><b>Visualizar Tipo de Usuário</b></h2>
                        </div>
                        <div class="col-md-6">
                            <a href="<?php echo base_url('13858aeb4c9a5807927c7b952dace1fb') ?>"><i style="margin-top: 10px; padding: 7px; border-radius: 5px; font-size: 17px; color: white" class="fa fa-reply bg-secondary" aria-hidden="true">VOLTAR</i></a>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <div class="col-md-12">
                        <div class="col-md-4">
                            <span style="font-size: 18px;" class="text-secondary"><b>DASHBOARD</b></span>
                        </div>
                        <div class="col-md-8">
                    ...
                    <div class="col-md-12">
                        <hr style="height: 1px">
                        <div class="col-md-4">
                            <span style="font-size: 18px;" class="text-secondary"><b>CATÁLOGO</b></span>
                        </div>
                        <div class="col-md-2">
                    ...
                    <div class="col-md-12">
                        <hr style="height: 1px">
                        <div class="col-md-4">
                            <span style="font-size: 18px;" class="text-secondary"><b>USUÁRIOS</b></span>
                        </div>
                        <div class="col-md-2">
                    ...
                    <div class="col-md-12">
                        <hr style="height: 1px">
                        <div class="col-md-4">
                            <span style="font-size: 18px;" class="text-secondary"><b>FINANCEIRO</b></span>
                        </div>
                        <div class="col-md-2">
                    ...
                    <!--    <hr style="height: 1px">-->
                    <!--    <div class="col-md-4">-->
                    <!--        <span style="font-size: 18px;" class="text-secondary"><b>MARKETING</b></span>-->
                    <!--    </div>-->
                    <!--    <div class="col-md-2">-->
                    ...
                    <div class="col-md-12">
                        <hr style="height: 1px">
                        <div class="col-md-4">
                            <span style="font-size: 18px;" class="text-secondary"><b>DEFINIÇÕES</b></span>
                        </div>
                        <div class="col-md-2">
                    ...
                    <div class="col-md-12">
                        <hr style="height: 1px">
                        <div class="col-md-4">
                            <span style="font-size: 18px;" class="text-secondary"><b>Lojas</b></span>
                        </div>
                        <div class="col-md-2">
