                                ...
                                <div class="tab-pane fade active in" id="caixas" style="padding-top: 1%" role="tabpanel" aria-labelledby="caixas-tab">
                                    <div class="table-responsive">
                                        <table class="table c-table" id="myTable">
                    				        <thead>
                    				            <tr>
                    				                <th style="width: 33%">Loja</th>
                    				                <th style="width: 33%">Data de Abertura:</th>
                    				                <th style="width: 33%">Funcionario que realizou Abertura:</th>
                    				                <th style="width: 33%">Valor em Caixa:</th>
                    				            </tr>
                    				        </thead>
                    				        <tbody>
                    				            <?php foreach($listacaixas as $cx){?>
                    				            <tr>
                    				                <td> <?php echo $cx['loja']; ?> </td>
                    				                <td> <?php echo $cx['abertura']; ?> </td>
                    				                <td> <?php echo $cx['funcionario']; ?> </td>
                    				                <td> <?php echo $cx['valor']; ?> </td>
                    				            </tr>
                    				            <?php }?>
