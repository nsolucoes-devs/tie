        				            ...
        				            <?php foreach($clientes as $c){ ?>
            				            <tr class="tr-check">
            				                ...
            				                <td style="color: #1b9045; font-size: 22px!important" class="text-center">
            				                    <a style="color: #1b9045;" href="<?php echo base_url('50d849c4ab008a40ab39cdaf352f35f5/' . $c['cliente_id']) ?>"><i class="fa fa-eye text-secondary" aria-hidden="true"></i></a>
            				                    <a style="color: #1b9045;" href="<?php echo base_url('admin/adminclientes/editarcliente/' . $c['cliente_id']) ?>"><i class="fa fa-pencil text-secondary" aria-hidden="true"></i></a>
            				                    <?php if($c['cliente_ativo'] == 1) { ?>
            				                        <i onclick="bloquear(<?php echo $c['cliente_id'] ?>)" data-toggle="modal" data-target="#bloquearModal" class="fa fa-ban text-secondary" aria-hidden="true"></i>
            				                    <?php } else { ?>
            				                        <i onclick="desbloquear(<?php echo $c['cliente_id'] ?>)" data-toggle="modal" data-target="#desbloquearModal" class="fa fa-check-circle-o text-secondary" aria-hidden="true"></i>
            				                    <?php } ?>
            				                    <a style="color: #1b9045;" href="<?php echo base_url('admin/adminclientes/excluircliente/' . $c['cliente_id']) ?>"><i class="fa fa-trash text-secondary" aria-hidden="true"></i></a>
            				                </td>
            				            </tr>
        				            <?php } ?>
        				        </tbody>
