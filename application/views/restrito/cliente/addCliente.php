            ...
            <div class="c-card-header">
                <div class="row">
                    <div class="col-md-12 text-left">
                        <h2 class="text-secondary"><b>Adicionar Cliente</b></h2>
                    </div>
                </div>
            </div>
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade active in" id="home" role="tabpanel" aria-labelledby="home-tab">
                        <div class="row" style="background-color: white; margin-left: 5px; margin-right: 5px">
                                    ...
                                    <div class="col-md-6 form-group" style="display: none">
                                        ...
                                        <select class="form-control" id="lojas" name="lojas" required>
                                            ...
                                            <?php foreach($lojas as $l){ ?>
                                                <option selected value="<?php echo $l['nome'] ?>"> <?php echo $l['nome'] ?> </option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row p-0">
                                <div class="col-md-12 text-center form-group p-0" style="margin-top: 2%">
