            ...
            <div class="c-card-header">
                <div class="row">
                    <div class="col-md-12 text-left">
                        <h2 class="text-secondary"><b>Adicionar Traje</b></h2>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row" style="background-color: white; margin-left: 5px; margin-right: 5px">
                            <div class="col-md-12">
                                ...
                                <!--<div id="detalhes" style="display: none">
                                    ...
                                    <div class="row" style="margin-top: 2%">
                                        <div class="col-md-12 form-group">
                                            ...
                                            <div id="editor"></div>
                                            <textarea name="desc" id="desc" style="display: none" <?php if($see === true){ echo "readonly";}?>><?php if(isset($traje['produto_detalhes'])){ echo $traje['produto_detalhes'];}?></textarea>
                                        </div>
                                    </div>
                                ...
                                <div id="imagens" style="display: none">
                                    ...
                                    <div class="col-md-12">
                                        <div class="row" style="margin-top: 2%">
                                            <div class="col-md-3 form-group" style="text-align:center; position: relative; left: 300px;">
                                                <label><b>Imagem:</b></label><br>
                                                <button type="button" class="btn btn-primary" style="width: 50%" onclick="$('#imagem').click()">Inserir</button>
                                    ...
                                    <div class="row" style="margin-top: 2%">
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            <select id="departamentos" name="departamentos[]" multiple class="js-example-basic-multiple" style="width: 100%!important;" <?php if($see === true){ echo "disabled";}  ?>>
                                                <?php $aux ="";
                                                if(isset($traje['produto_marca_id'])){
                                                        $aux = explode("¬", $traje['produto_marca_id']);
                                                    }
