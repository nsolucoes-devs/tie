            ...
            <div class="c-card-header">
                <div class="row d-flex justify-content-between">
                    <div class="col-md-6 text-left">
                        <h2 style="color: #6c757d;"><b>Listagem de Trajes</b></h2>
                    </div>
                    <form class="col-md-6" action="<?php echo base_url('391a027a8fef2eba4487a00156901156') ?>" method="post">
                        <div>
                            <div class="button-area">
                                
                                <div class="search-field" style="display: none;">
                                    <input type="text" id="search" name="filtro" class="form-control-custom" style="height: 34px;" value="<?php if (isset($filtro)) {
                                                                                                                                                echo $filtro;
                                                                                                                                            } ?>">
                    ...
                    <table class="table c-table" id="tabela">
                        <thead>
                            <tr>
                                ...
                                <th class="text-secondary" style="width: 5%">Cod.</th>
                                <th class="text-secondary" style="width: 30%">Nome do Traje</th>
                                <th class="text-secondary" style="width: 20%">Modelo</th>
                                <th class="text-secondary" style="width: 10%">Status</th>
                                <th class="text-center text-secondary" style="width: 20%"></th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php foreach ($produtos as $prod) { ?>
                                <tr class="tr-check">
                                    <td>
                                        <span class="pop" title="Visualizar imagem">
                                            <img class="img-fluid preview-img" src="<?= $prod['produto_imagens_opcional1'] ?>" alt="<?php echo ucwords(mb_strtolower($prod['produto_nome'])) ?>">
                                        </span>
                                    </td>
                                    ...
                                    <td style="color: #1b9045; font-size: 22px!important" class="text-center">
                                        <a style="color: #1b9045;" href="<?php echo base_url('42f4c8bb0611326498144132e81203e5/' . $prod['produto_id']) ?>"><i class="fa fa-eye text-secondary" aria-hidden="true"></i></a>
                                        <a style="color: #1b9045;" href="<?php echo base_url('ba641dd761d2b77e2dd91ebff5201646/' . $prod['produto_id']) ?>"><i style="padding-left: 12px;" class="fa fa-pencil text-secondary" aria-hidden="true"></i></a>
                                        <i onclick="excluirproduto(<?php echo $prod['produto_id'] ?>)" data-toggle="modal" data-target="#statusModal" style="padding-left: 12px;" class="fa fa-trash text-secondary" aria-hidden="true"></i>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
    ...
    <div class="modal-dialog" role="document" style="margin: 30px auto 0 auto">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p style="font-size: 17px;"><b> Deseja excluir o produto? </b>
                <p>
            </div>
    ...
    <div class="modal-dialog modal-dialog-centered" data-dismiss="modal">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <h3 class="title text-center text-dark"></h3>
            </div>
        </div>
    </div>
</div>
    ...
    $(document).ready(function() {
        $('#tabela').DataTable({
            language: {
                ...
                search: '<a href="<?php echo base_url('ef0baa3c473197057bfddb0e9b0d6169') ?>"><button type="button" class="btn btn-secondary" style="margin-right: 15px" title="Adicionar Item"><em class="fa fa-plus"></em></button></a><em class="fa fa-search"></em>',
                lengthMenu: "Exibir _MENU_  por Página",
                info: "Exibindo _START_ &agrave; _END_ de _TOTAL_ trajes",
                infoEmpty: "Exibir de l'&eacute;lement 0 &agrave; 0 sur 0 &eacute;l&eacute;ments",
        ...
        setTimeout(function() {
            $("select[name='tabela_length']").removeClass('input-sm');
        }, 1000);
    });
</script>
