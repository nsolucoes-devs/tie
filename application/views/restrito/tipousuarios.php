            ...
            <div class="c-card-header">
                <div class="row px-3">
                    <div class="col-md-8 text-left">
                        <h2 class="text-secondary"><b>Listagem de Tipos de Usuários</b></h2>
                    </div>
                    <div class="col-md-4">
            ...
            <div class="c-card-body">
                <div class="table-responsive" style="width: 100%">
                    <table class="table c-table" id="tabela">
                        <thead>
                            <tr>
                                <th class="text-secondary" style="width: 45%">Nome do Perfil</th>
    			                <th class="text-secondary" style="width: 20%">Criado em</th>
    			                <th class="text-secondary text-center" style="width: 20%">Ações</th>
                            </tr>
                        </thead>
                        <tbody>
    			            ...
    			            <tr class="tr-check">
    			                ...
    			                <td style="color: #1b9045; font-size: 22px!important" class="text-center">
    		                        <a style="color: #1b9045;" href="<?php echo base_url('89c668a56667d167778b11b98d4e7796/' . $at['perfilusuario_id'] ) ?>"><i class="fa fa-eye text-secondary" aria-hidden="true"></i></a>
