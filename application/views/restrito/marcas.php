...
<section id="main-content">
    <section class="wrapper">
        ...
        <div class="c-card">
            <div class="c-card-header px-3">
                <div class="row d-flex justify-content-between">
                    <div class="col-md-6 text-left">
                        <h2 class="text-secondary"><b>Listagem de Marcas</b></h2>
                    </div>
                    <form class="col-md-6" action="<?php echo base_url('edb728d5b2d758ff44b1b0e9f991ead9') ?>" method="post">
                        <div>
                            <div class="button-area">
                                <button type="button" class="btn btn-secondary" style="margin-right: 15px" title="Adicionar Item" data-toggle="modal" data-target="#marca_adicionarmodal"><em class="fa fa-plus"></em></button></a>
            ...
            <div class="c-card-body">
                <div class="table-responsive" style="width: 100%">
                    ...
                    <thead>
                        <tr>
                            <th class="text-secondary" style="width: 55%">Nome</th>
                            <th class="text-secondary" style="width: 30%">Status</th>
			                <th class="text-center text-secondary" style="width: 15%">Ações</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="color: #1b9045; font-size: 22px!important" class="text-center">
			                    <a onclick="verMarca(<?php echo $m['marca_id']; ?>, '<?php echo $m['marca_nome']; ?>', <?php echo $m['marca_ativo']; ?>)"style="color: #1b9045;" data-toggle="modal" data-target="#marca_vermodal"><i class="fa fa-eye text-secondary" aria-hidden="true"></i></a>
			                    <a onclick="editarMarca(<?php echo $m['marca_id']; ?>, '<?php echo $m['marca_nome']; ?>', <?php echo $m['marca_ativo']; ?>)" style="color: #1b9045;" data-toggle="modal" data-target="#marca_editarmodal"><i style="padding-left: 12px;" class="fa fa-pencil text-secondary" aria-hidden="true"></i></a>
			                    <i onclick="excluirMarca(<?php echo $m['marca_id']; ?>)" data-toggle="modal" data-target="#marca_excluirmodal" style="padding-left: 12px; color: #1b9045" class="fa fa-trash text-secondary" aria-hidden="true"></i>
    			            </td>
			            </tr>   
			            <?php } ?>
                    </tbody>
...
<div class="modal fade" id="marca_editarmodal" tabindex="-1" role="dialog" aria-labelledby="marca_editarmodal" aria-hidden="true">
  <div class="modal-dialog" role="document" style="margin: 30px auto 0 auto">
    <div class="modal-content">
      <div class="m-header bg-dark" style="padding: 15px; border-radius: 4px 4px 0 0;">
        <h4 class="modal-title" style="color: white; display: inline;"><b>Editar Marca</b></h4>
        <button type="button" style="color: white" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
<div class="modal fade" id="marca_vermodal" tabindex="-1" role="dialog" aria-labelledby="marca_vermodal" aria-hidden="true">
  <div class="modal-dialog" role="document" style="margin: 30px auto 0 auto">
    <div class="modal-content">
      <div class="m-header bg-dark" style="padding: 15px; border-radius: 4px 4px 0 0;">
        <h4 class="modal-title" style="color: white; display: inline;"><b>Marca</b></h4>
        <button type="button" style="color: white" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
