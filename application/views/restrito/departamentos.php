        ...
        <div class="c-card">
            <div class="c-card-header">
                <div class="row px-3">
                    <div class="col-md-6 text-left">
                        <h2 class="text-secondary"><b>Listagem de Departamentos</b></h2>
                    </div>
                    <div class="col-md-6">
                        <form action="<?php echo base_url('48b6bbfcf12b55d9b0e4c2ded7384bff') ?>" method="post">
                            <div class="button-area">
                                <a href="<?php echo base_url('4e54b724389db47bc1f3a97881abf180') ?>"><button type="button" class="btn btn-secondary" style="margin-right: 15px" title="Adicionar Item"><em class="fa fa-plus"></em></button></a>
            ...
            <div class="c-card-body">
                <div class="table-responsive" style="width: 100%">
                    ...
                    <thead>
                        <tr>
                            <th class="text-secondary" style="width: 60%">Departamento</th>
                            <th class="text-secondary" style="width: 20%">Situação</th>
                        ...
                        <?php foreach($departamentos as $d) { ?>
                            <tr>
                                ...
                                <td style="color: green; font-size: 22px!important" class="text-center">
				                    <a style="color: green;" href="<?php echo base_url('5a8ec7a88f44e3ad4fb71e79c2b7523d/' . $d['departamento_id']) ?>"><i class="fa fa-eye text-secondary" aria-hidden="true"></i></a>
				                    <a style="color: green;" href="<?php echo base_url('0665a012413c78b2017cf726f29d22fd/' . $d['departamento_id']) ?>"><i style="padding-left: 12px;" class="fa fa-pencil text-secondary" aria-hidden="true"></i></a>
				                    <i onclick="excluir(<?php echo $d['departamento_id'] ?>)" data-toggle="modal" data-target="#statusModal" style="padding-left: 12px;" class="fa fa-trash text-secondary" aria-hidden="true"></i>
				                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
