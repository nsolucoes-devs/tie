                ...
                <div class="c-card-header">
                    <div class="row px-3">
                        <div class="col-md-6 text-left">
                            <h2 class="text-secondary"><b>Listagem De Usuários</b></h2>
                        </div>
                        <div class="col-md-6">
                            <form action="<?php echo base_url('0d658457c62859e2c93026f9f70ce219') ?>" method="post">
                                <div class="button-area">
                                    <a onclick="addModal()" data-toggle="modal" data-target="#novoAdmin" class="btn btn-secondary mr-15" title="Adicionar Usuário"><em class="fa fa-plus"></em></a>  
            				        ...
            				        <tbody>
            				            ...
            				            <tr>
            				                ...
            				                <td style="color: #1b9045; font-size: 22px!important;" class="text-center">
            				                    <i onclick="setaDadosModal3(<?php echo $row['id_usuario'] ?>)" class="fa fa-eye text-secondary" aria-hidden="true"></i>
            				                    <i onclick="setaDadosModal(<?php echo $row['id_usuario'] ?>)"   style="padding-left: 12px;" class="fa fa-pencil text-secondary" aria-hidden="true"></i>
            				                    <?php if($row['ativo'] == 1){ ?>
            				                        <i onclick="excluirusuario(<?php echo $row['id_usuario'] ?>)" data-toggle="modal" data-target="#modalExcluir"  style="padding-left: 12px;" class="fa fa-ban text-secondary" aria-hidden="true"></i>
            				                    <?php } else { ?>
            				                        <i onclick="desbloquearusuario(<?php echo $row['id_usuario'] ?>)" data-toggle="modal" data-target="#modalDesbloquear"  style="padding-left: 12px;" class="fa fa-check-circle-o text-secondary" aria-hidden="true"></i>
            				                    <?php } ?>
            				                    <a style="color: #1b9045;" onclick="removeUser('<?php echo $row['id_usuario'];?>')"><i class="fa fa-trash text-secondary" aria-hidden="true"></i></a>
            				                </td>
            				            </tr>
            				            <?php } ?>
            				        </tbody>
        ...
        <div class="modal-dialog modal-dialog-cad">    
            <div class="modal-content">
                <div class="d-flex justify-content-between bg-dark" style="padding: 15px;">
                    <h4 class="modal-title" id="titulo-modal"><b>Novo Usuário</b></h4>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <select style="width: 100%" class="form-control form-select" name="permissao" id="permissao" required>
    ...
    <div id="verAdmin" class="modal">
        <div class="modal-dialog modal-dialog-cad">
            ...
            <div class="modal-content">
                <div class="d-flex justify-content-between bg-dark" style="padding: 15px;">
                    <h4 class="modal-title"><b>Visualizar Usuário</b></h4>
                    <button type="button" class="close text-white" data-dismiss="modal">&times;</button>
                </div>
                <form method="post" id="form_insert">
                    <input type="hidden" id="user_id" name="user_id">
  ...
  <div class="modal-dialog" role="document" style="margin: 30px auto 0 auto;">
    <div class="modal-content">
      <div class="bg-dark" style="padding: 15px;">
        <h4 class="modal-title" style="color: white; display: inline;"><b>Bloqueio de Usuário</b></h4>
