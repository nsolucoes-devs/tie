        ...
        <div class="row" style="margin-bottom: 5px;">
            <div class="col-md-12">
                ...
                <div class="form-group" <?php if($mobile ==0){ ?> style="margin-bottom: -10px;" <?php } ?> >
                    ...
                    box-shadow: 0 0px 0px 0px rgb(0 0 0 / 14%), 0 0px 0px 0px rgb(156 39 176 / 40%); margin-left: 69%; padding-top: 7px; position: relative; top: -40px; left: 14%; margin-bottom: -16%;" 
                    ...
                    <select <?php if($_SESSION['loja_id'] != 0){echo "disabled";}?>  class="form-control" id="loja_id" onchange="diasDash(false)" style="margin-bottom: 3%;">
                            <option value="all" selected disabled>Selecione a loja</option>
                            <?php
                            foreach($lojas as $loja){ ?>
                                <option <?php if($loja['id'] == $_SESSION['loja_id']){echo "selected";}?> value="<?php echo $loja['id'] ?>"><?php echo $loja['nome']?></option>
                            <?php } ?>
                        </select>
        ...
        <div class="panel panel-default" style="background-color: #30a5ff; position: relative; z-index: 99;">
            ...
            <?php }else{ ?>
                ...
                <table style="text-align: center; position: relative; left: -3%;">
                    ...
                    <tr>
                        <td style="color: white;"><label>R$ </label><input id="subtotal">0,00</input></td>
                        <td style="color: gold; font-size: 14px;"><label>R$ </label><input id="total2">0,00</input></td>
                    </tr>
                </table>
            <?php } ?>
            </div>
      ...
      <div class="modal-header" style="background-color: #30a5ff;">
        <div class="row">
            <div class="col-md-12 col-xs-12">
                <h4 class="modal-title">Entre como gerente ou administrador para CANCELAR A ÚLTIMA VENDA</h4>
            </div>
        </div>  
      </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header" style="background-color: #30a5ff;">
        <div class="row">
            <div class="col-md-12 col-xs-12">
                <h4 class="modal-title">Entre como gerente ou administrador para FECHAR O CAIXA</h4>
            </div>
        </div>  
      </div>
