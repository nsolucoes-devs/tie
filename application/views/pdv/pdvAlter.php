...
<style>
    ...
    @media (min-width: 800px) and (max-width: 1150px) and (orientation: landscape){
        /*.logo-loja-pdv{*/
        /*    width: 200px;*/
        /*}*/
...
<div class="row" style="padding: 4% 0% 0 2%; margin-right: 1%; margin-bottom: -10%;">
    <div class="col-md-4">
        <!-- Dados do Produto -->
        <div class="row" style="margin-bottom: 5px;">
            <div class="col-md-12">
                ...
                <div class="form-group" style="margin-bottom: -10px;" >
                        ...
                        <div class="row">
                            <div class="<?php if($mobile == 0){ ?>col-sm-6<?php }else{ ?>col-xs-6<?php } ?>">
                                <!--<label><b>Loja</b></label>-->
                                <img class="logo-loja-pdv" style="height: auto; width: 130%; margin-top: -5px; margin-bottom: 15%;" src="<?php echo base_url('/imagens/site/logo2.png')?>" alt="">
                            </div>
                            <div class="<?php if($mobile == 0){ ?>col-sm-6<?php }else{ ?>col-xs-6<?php } ?>" style="display: flex; justify-content: right;">
                                <!--<label><b>Vendedor</b></label>-->
                                    <div class="bt-vend-loja" style="margin-top: 40%;">
                                ...
                                <?php } ?>
                                <div class="bt-config" style="margin-top: 40%; margin-left: 9%; margin-right: 6%; position: relative;">
                                    ...
                                    <div id="configlista" style="position: absolute; z-index: 999; display: none;">
                                        <div class="drop-content-pdv" style="width: 195%; position: relative; left: -105%;">
                                            <!--<a onclick="verificaSenha('reimprime')"><p style="text-align: right">Reimprimir Última Venda</p></a>-->
                                            <!--<?php if($_SESSION['perfil'] != 9){ ?><a onclick="verificaSenha('cancela')"><p style="text-align: right">Cancelar Última Venda</p></a><?php } ?>-->
                                            <!--<?php if($_SESSION['perfil'] != 9){ ?><a onclick="verificaSenha('fecha')"><p style="text-align: right">Fechar Caixa</p></a><?php } ?>-->
                                            ...
                                            <a href="<?php if($_SESSION['perfil'] == 9){
                                                    ...
                                                    echo base_url('106a6c241b8797f52e1e77317b96a201');} ?>">
                                                <p style="text-align: right; font-size: 20px;">Voltar</p>
                                            </a>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="row" >
            <div class="col-md-12" >
                ...
                <div class="form-group text-center" style="margin-bottom: -5px;" >
                    <button id="btnIncluir" type="button" class="btn btn-primary" onclick="buscarProduto(true)" style="width: 100%; background-color: #30a5ff!important; height: 45px; font-size: 20px; font-weight: bold; box-shadow: 0 0px 0px 0px rgb(0 0 0 / 14%), 0 0px 0px 0px rgb(156 39 176 / 40%);">INCLUIR</button>
                </div>
            </div>
        </div>
                ...
                <div class="panel panel-defalut" style="padding: 10px; background-color: #f7f7f7;">
                    <div id="divAcres" >
                        <div class="form-group">
                            ...
                            <button id="btDesconto" class="btn btn-primary" data-toggle="modal" data-target="#modalDesconto" 
                            style="background-color: #30a5ff!important; box-shadow: 0 0px 0px 0px rgb(0 0 0 / 14%), 0 0px 0px 0px rgb(156 39 176 / 40%); width: 100%; height: 45px; font-size: 20px; font-weight: bold; width: 45%;">HABILITAR</button>
                            <input type="text" id="desconto" value="0.00" name="desconto" class="form-control money" 
                            onchange="mudarDesconto()" style="display:none; width: 100%; position: initial ; top: -39px; left: 55%; margin-bottom: -45px;">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="col-md-8" style="position: relative; z-index: 1;">
        ...
        <div class="panel panel-default" style="background-color: #30a5ff; position: relative; z-index: 99;">
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-4 col-xs-6 col-sm-6 col-lg-4 text-right">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-6">
                                <input id="subtotal" class="money" type="text" style="color: white; float: left; background:transparent; border:none; position: relative; top: 6px; left: -7%; font-size: 18px;" disabled>
                            </div>  
                        </div>
                    </div>
                    
                    <div class="col-md-4 col-xs-6 col-sm-6 col-lg-4 text-center">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-6">
                                <input id="desconto2" class="" type="text" style="color: white; float: left; background:transparent; border:none; position: relative; top: 6px; left: -7%; font-size: 18px;" value="0" disabled>
                            </div> 
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-xs-12 col-sm-12 col-lg-4  text-center">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-6">
                                <input id="total2" class="money" type="text" style="color: white; float: left; background:transparent; border:none; position: relative; top: 6px; left: -7%; font-size: 18px;" disabled>
                            </div>  
                        </div>
                    </div>
                </div>
        ...
        <div class="row" style="margin-bottom: 30px; position: relative; z-index: 99;">
            <div class="col-md-6 col-xs-6 col-sm-6 col-lg-6">
                <a class="btn btn-primary largura-bt-ipad" onclick="window.location.reload();" style="width: 100%; padding: 20px; font-size: 20px; font-weight: bold; background-color: red!important; border: 0px; box-shadow: 0 0px 0px 0px rgb(0 0 0 / 14%), 0 0px 0px 0px rgb(156 39 176 / 40%);" >CANCELAR</a>
            </div>
            <div class="col-md-6 col-xs-6 col-sm-6 col-lg-6">
                <a class="btn btn-primary largura-bt-ipad" onclick="setaDadosModal3()" style="width: 100%; padding: 20px; font-size: 20px; font-weight: bold; background-color: green; border: 0px; margin-left: 1.5%;  box-shadow: 0 0px 0px 0px rgb(0 0 0 / 14%), 0 0px 0px 0px rgb(156 39 176 / 40%);" >FINALIZAR</a>
            </div>
        </div>
                ...
                <div class="container" style="width: 100%;">
                    <div class="row">
                        ...
                        <?php if($_SESSION['loja_id'] != 0){?>
                            ...
                            <select class="js-example-basic-multiple form-control" id="loja_id" style="margin-bottom: 8%; width: 100%!important;" <?php if($place != 0){ echo "disabled";}?>>
                                <option value="-1" selected disabled>Loja</option>
                            <?php foreach($lojas as $loja){ ?>
                                <option value="<?php echo $loja['id'] ?>"><?php echo $loja['nome']?></option>
                            <?php } ?>
                        ...
                        if($vend['id_funcionario'] == $_SESSION['func_id']){?>
                            <input type="text" class="form-control" style="margin-bottom: 3%;" readonly value="<?php echo $vend['nome_funcionario'];?>">
                        <?php } } }else{?>
                            <select class="js-example-basic-multiple form-control" id="vendedor_id" style="margin-bottom: 3%; width: 100%!important;">
                                <option value="-1" selected disabled>Vendedor</option>
                                <?php foreach($vendedor as $vend){ ?>
                                    <option value="<?php echo $vend['id_funcionario'] ?>"><?php echo $vend['nome_funcionario']?></option>
                                <?php } ?>
...
<!-- Modal Reimprime Última Venda -->
<div class="modal" id="modalReimprimeUltimaVenda">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header" style="background-color: #30a5ff;">
        <div class="row">
            <div class="col-md-12 col-xs-12">
                <h4 class="modal-title">Reimpressão de Última Venda</h4>
            </div>
        </div>  
      </div>
      ...
      <div class="modal-body" id="desc">
         ...
         <div class="form-group">
             <label>Usuário</label>
             <input type="text" name="usuarioDesconto9" id="usuarioDesconto9" placeholder="Usuário"
             class="form-control">
         </div>
          
         <div class="form-group">
             <label>Senha</label>
             <input type="password" name="senhaDesconto9" id="senhaDesconto9" placeholder="Senha"
             class="form-control">
         </div>
        ...
        <div class="form-group alert alert-danger text-center" role="alert" style="display: none;" id="erroUsuario2">
         ...
         <div class="form-group text-center">
            <button class="btn btn-success" onclick="ultimaVenda()">
                Confirmar</button>
         </div>
      </div>
      ...
      <div class="modal-body" style="height:65vh; overflow-y:auto;">
            ...
            <div class="row" id="listaTroca1">
                ...
                <div class="col-md-7 form-group">
                    <label for="trocaProduto">Produto Recebido (Entrada)</label>
                    <select class="js-example-basic-multiple form-control" id="trocaProduto" name="trocaProduto[]" style="width: 100%;">
                        <option value="-1" selected disabled>Selecione o Produto</option>
                ...
                <div class="col-md-4 form-group">
                    ...
                    <input onblur="diferenca()" class="form-control money"  type="text" id="trocaValor" name="valorTroca[]" placeholder="Valor do Produto">
                </div>
            </div>    
            ...
            <div class="row">
                <div class="col-md-12 form-group">
                    ...
                    <input class="form-control" type="text" id="trocaObs" name="trocaObs" placeholder="Descreva suas observações aqui.">
                </div>
            </div>
                ...
                if(data.id != "" || data.id != null){
                    ...
                    Swal.fire({
                      ...
                      if (result.dismiss === Swal.DismissReason.timer) {
                        ...
                        window.location.href = '<?php echo base_url('impressoes/geraCupom/');?>'+ data.id;
                        console.log(data.id);
