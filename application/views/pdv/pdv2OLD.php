        ...
        <div class="row" >
            <div class="col-md-12" >
                <div class="panel panel-defalut" style="padding: 10px;">
                    ...
                    else echo "display: none;"?>" type="number" placeholder="%" id="desconto" name="desconto" class="form-control" oninput="mudarDesconto()">
    ...
    function deletarProduto(id){
        ...
        for (i=0; i < table.rows.length; i++){
            ...
            if(colunas[0].innerHTML == id){
                ...
                if(desconto != "" && desconto != "0"){
                    desconto2 = (total / 100) *  parseFloat(desconto);
                    total -= desconto2;
                }
                
                if(acrescimo != "" && acrescimo != "0"){
                    acrescimo2 = (total / 100) *  parseFloat(acrescimo);
                    total += acrescimo2;
                }
