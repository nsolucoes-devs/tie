...
<html lang="pt-br">
    ...
    <head>
        ...
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.1.2/css/fontawesome.css" integrity="sha512-VoR2Y+jYERzZdXUtiFB4JmQSTBR9+vQ7LA1BhQ6rLcZKd8bc5h0wAfbO8qk+vEZnGreFBPG5Ko6jnDWUxhLbmw==" crossorigin="anonymous" referrerpolicy="no-referrer" /> -->
      ...
      <section id="container">
            ...
            <style>
                .select2-container--bootstrap.select2-container--focus .select2-selection, .select2-container--bootstrap.select2-container--open .select2-selection {
                    box-shadow: inset 0 1px 1px rgb(0 0 0 / 8%), 0 0 8px rgb(194 194 194 / 60%);
                                ...
                                <p class="opt-menu <?php if($idpag == 8){echo "ativo-h";} ?>">
                                    ...
                                    <div class="custom-drop">
                                        <div class="drop-content">
                                            ...
                                            <a href="<?php echo base_url('reservas') ?>"><p class="bb">Locação</p></a> 
                                            <?php }?>
                                            <?php if(strpos($perm, "LisL")){?>
                                            <a href="<?php echo base_url('listaLocacao') ?>"><p class="bb">Reservas</p></a> 
                                            <?php }?>
                                ...
                                <div class="col-md-1 text-center div-drop">
                                    ...
                                    <div class="custom-drop">
                                        <div class="drop-content">
                                            ...
                                            <a href="<?php echo base_url('af8889282b50f9030f8cc7a19b3f706d') ?>"><p>Empresa</p></a>
                                            <?php// }?> -->
