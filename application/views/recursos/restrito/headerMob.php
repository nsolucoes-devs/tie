                    ...
                    <div class="col-md-7 text-right my-auto">
                        <div class="top-menu">
                            <div class="row" id="opts">
                                <?php if(strpos($perm, "¬DASH¬") !== false){?>
                                <div class="col-md-1 text-center" style="margin-left: 50%;">
