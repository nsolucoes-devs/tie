...
;(function(factory) {
            ...
            _.initials = {
                ...
                dates: {
                    ...
                    pt: {
                        ...
                        noEventForToday: "Não à locações para hoje, iniciar uma locação! :)",
                        noEventForThisDay: "Não à locações para hoje, iniciar uma locação! :)",
    ...
    EvoCalendar.prototype.addEventList = function(event_data) {
        ...
        markup = '<div class="event-container" onclick="detalhes('+(event_data.id)+')" role="button" data-event-index="'+(event_data.id)+'">';
